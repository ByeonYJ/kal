...
<<<<<<< HEAD
	.kal-star-input>.input,
.kal-star-input>.input>label:hover,
.kal-star-input>.input>input:focus+label,
.kal-star-input>.input>input:checked+label{
=======
	.star-input>.input,
...
.kal-star-input>.input>input{
    position: absolute;
    width: 1px;
    height: 1px;
    opacity: 0;
}
.kal-star-input>.input.focus{
    outline: 1px dotted #ddd;
}
.kal-star-input>.input>label{
    width: 10px;
    height: 0;
    padding: 19px 0 0 0;
    overflow: hidden;
...
.kal-star-input>.input>label:hover~label{
    background-image: none;
}
.kal-star-input>.input>label[for="p1"]{ 
    width: 10px;
    z-index: 10;
}
.kal-star-input>.input>label[for="p2"]{ 
    width: 20px;
    z-index: 9;
}
.kal-star-input>.input>label[for="p3"]{ 
    width: 30px;
    z-index: 8;
}
.kal-star-input>.input>label[for="p4"]{ 
    width: 40px;
    z-index: 7;
}
.kal-star-input>.input>label[for="p5"]{ 
    width: 50px;
    z-index: 6;
}
.kal-star-input>.input>label[for="p6"]{ 
    width: 60px;
    z-index: 5;
}
.kal-star-input>.input>label[for="p7"]{ 
    width: 70px;
    z-index: 4;
}
.kal-star-input>.input>label[for="p8"]{ 
    width: 80px;
    z-index: 3;
}
.kal-star-input>.input>label[for="p9"]{ 
    width: 90px;
    z-index: 2;
}
.kal-star-input>.input>label[for="p10"]{ 
    width: 100px;
    z-index: 1;
}
.kal-star-input>output{
    display: inline-block;
    width: 36px;
    text-align: right;
}
.kal-star-input>output>b{
=======
.star-input{
    white-space: nowrap;
}
...
.kal-hy-review-bg {
	background-image: url(/web/resources/img/customerService/review-bg.jpg);
	background-size: cover;
	background-position: center;
	background-position-y: 45px; height : 750px; background-attachment :
	cover;
...
.kal-hy-review-type-ul {
	position: fixed;
	top:18%;
	left: 18%; list-style-type : none;
	margin: 0;
	padding: 0;
	width: 15%;
...
.kal-hy-review-type-li a.active {
	background-color: #3080a8;
	color: white;
}

.kal-hy-review-type-li a:hover:not(.active)
...
.kal-hy-review-post-camera-icon {
	margin: 15px 0px;
	text-align: center;
	font-size: 15px;
	color: #428aaf;
...
<jsp:include page="/WEB-INF/views/common/sub-gnb-after-login.jsp" flush="false"/> 
	...
	<div class="kal-hy-review-bg">
		<h3>리뷰</h3>
	
		<div class="kal-hy-container">
			<div class="kal-hy-wrapper" style="margin-top: 50px;">
				<div class="kal-hy-review-bg2">
				<div class="kal-hy-review-text"><h3>리뷰를 남겨 주세요</h3></div>
					<ul style="margin-top: 5%;" class="kal-hy-review-type-ul">
						<li class="kal-hy-review-type-li"><a class="active"
							href="#home">고객의 소리</a></li>
						<li class="kal-hy-review-type-li"><a href="#compliment">칭 찬</a></li>
						<li class="kal-hy-review-type-li"><a href="#complaint">불 만</a></li>
						<li class="kal-hy-review-type-li"><a href="#suggestion">제 의</a></li>
						<li class="kal-hy-review-type-li"><a href="#inquiry">문 의</a></li>
					</ul>
					<div class="kal-hy-review"
						style=" width: 50%; margin-left: 30%;margin-top: 5%;">

						<div
							style=" margin-top:-40px;height: 280px; width: 600px;">
							<span style="margin-top:0px; padding: 7px 88%; background-color: #66a4c4">
								<a  class="kal-hy-review-post-context">게시물 작성</a>
							</span>

							<textarea style="margin-top:3%; width: 600px; height: 150px;" rows="4" cols="50"
								maxlength="1000" placeholder="소중한 고객의 소리를 남겨주세요">
							</textarea>
							<a href=""><i class="fa fa-camera"></i></a> <a
								style="padding: 3%" href=""><i class="fa fa-star"></i></a> <br />
							<input class="kal-hy-review-button" type="button" value="완료" />
						</div>
						<div><span style="position: absolute;top: 60%;">총게시글수</span></div>
						<div></div>
						<div>
							<span id="kal-review-hy-review"
								style="padding: 1px 562px; color: white; background-color: #a8a4a4"><span
								style="text-align: center">more▼</span> </span>
						</div>
						<div id="kal-review-hy-reply" style="border-bottom: 1px solid black;">
							똥이 <br />
							ㅎㅎㅎㅎㅎㅎㅎ
						</div>
					</div>
	...
	<span >▶환경</span>
	<span class="kal-star-input">
  <span class="input">
    <input type="radio" name="kal-star-input" id="p1" value="1"><label for="p1">1</label>
    <input type="radio" name="kal-star-input" id="p2" value="2"><label for="p2">2</label>
    <input type="radio" name="kal-star-input" id="p3" value="3"><label for="p3">3</label>
    <input type="radio" name="kal-star-input" id="p4" value="4"><label for="p4">4</label>
    <input type="radio" name="kal-star-input" id="p5" value="5"><label for="p5">5</label>
    <input type="radio" name="kal-star-input" id="p6" value="6"><label for="p6">6</label>
    <input type="radio" name="kal-star-input" id="p7" value="7"><label for="p7">7</label>
    <input type="radio" name="kal-star-input" id="p8" value="8"><label for="p8">8</label>
    <input type="radio" name="kal-star-input" id="p9" value="9"><label for="p9">9</label>
    <input type="radio" name="kal-star-input" id="p10" value="10"><label for="p10">10</label>
  </span><output for="kal-star-input"><b>0</b>점</output><input type="submit" value="평점주기"><br />
  	<span >▶직원 서비스</span>
  	<span class="kal-star-input">
  <span class="input">
    <input type="radio" name="kal-star-input" id="p1" value="1"><label for="p1">1</label>
	...
	<span >▶깨끗함</span><span class="kal-star-input">
  <span class="input">
    <input type="radio" name="kal-star-input" id="p1" value="1"><label for="p1">1</label>
    <input type="radio" name="kal-star-input" id="p2" value="2"><label for="p2">2</label>
    <input type="radio" name="kal-star-input" id="p3" value="3"><label for="p3">3</label>
    ...
    <input type="radio" name="kal-star-input" id="p9" value="9"><label for="p9">9</label>
    <input type="radio" name="kal-star-input" id="p10" value="10"><label for="p10">10</label>
  </span><output for="kal-star-input"><b>0</b>점</output><input type="submit" value="평점주기"><br /><br />
=======
...
<<<<<<< HEAD
<span><button id="mypageUserInfo" class="kal-hy-grade-button2" >뒤로가기</button> </span>
</span>
</div>
	</div>
...
=======
						<div
							...
							<a href="#"><i class="fa fa-camera"></i></a> <a id="fatest" style="padding: 3%" href="#"><i class="fa fa-star"></i></a> <br />
							<input class="kal-hy-review-button" type="button" value="완료" />
						</div>
						<div><span style="position: absolute;top: 60%;">총게시글수</span></div>
						<div></div>
...
<<<<<<< HEAD
	...
	$($('.kal-hy-grade').on('click', function() {
		alert('평점');

	}));
	$('#kal-review-hy-reply').hide();
	$($('#kal-review-hy-review').on('click', function() {
		$('#kal-review-hy-reply').show();

	}));
=======
	$('#fatest').on('click',function(){
	   alert('평점');
